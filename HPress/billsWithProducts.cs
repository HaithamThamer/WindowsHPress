...
{
    public partial class billsWithProducts : DevExpress.XtraReports.UI.XtraReport
    {
        bool isDinar = true;
        HDatabaseConnection.HMySQLConnection databaseConnection;

        public billsWithProducts(HDatabaseConnection.HMySQLConnection databaseConnection, System.Windows.Forms.DataGridView result,string reportName,bool isDinar,bool isCash,DateTime from,DateTime to,double dollarValue,string empName)
        {
            InitializeComponent();
